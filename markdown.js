...
Markdown.url_regex = /^((ftp|https?):\/\/)?[-\w]+\.([-\w]+\.)*(com|edu|biz|gov|in(?:t|fo)|mil|net|org|name|coop|aero|museum|asia|army|arpa|domains|email|host|wtf|codes|adult|actor|android|audio|beer|bio|uno|business|[a-z][a-z]|\d+)(:\d+)?($|(\/\S?(\/\S)*\/?)|(\#\S?)|(\?\S?))/i;
